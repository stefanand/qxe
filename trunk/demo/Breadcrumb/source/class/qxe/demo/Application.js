...
//      var frame = new qx.ui.container.Composite(new qx.ui.layout.Grow);
      ...
      var breadcrumb = new qxe.ui.navigation.Breadcrumb();
      breadcrumb.setWidth(600);
//      frame.add(menubar);

      var fileMenu = new qxe.ui.navigation.Link("File", null, this.getFileMenu());
      var editMenu = new qxe.ui.navigation.Link("Edit", null, this.getEditMenu());
      var searchMenu = new qxe.ui.navigation.Link("Search", null, this.getSearchMenu());
      var viewMenu = new qxe.ui.navigation.Link("View", null, this.getViewMenu());
      var formatMenu = new qxe.ui.navigation.Link("Format", null, this.getFormatMenu());
      var helpMenu = new qxe.ui.navigation.Link("Help", null, this.getHelpMenu());

      breadcrumb.add(fileMenu);
      breadcrumb.add(editMenu);
      breadcrumb.add(searchMenu);
      breadcrumb.add(viewMenu);
      breadcrumb.add(formatMenu);
      breadcrumb.add(helpMenu);

      doc.add(breadcrumb, {left: 0, top: 0});
    },
