 ...
 */
qx.Class.define("qxe.ui.mobile.form.ButtonPane",
{
  ...
  */
  ...
  statics :
  {
    ...
    {
      var buttonPane = new qxe.ui.mobile.form.ButtonPane();
      buttonPane.set(json);
  ...
  members :
  {
    ...
    */
    ...
    _applyOrientation : function(value, old)
    {
      ...
      if (value === "horizontal")
      {
        var layout = new qx.ui.mobile.layout.HBox(this.getSpacing());
//rtl        layout.setReversed(qx.locale.Manager.getInstance().getDirection() == "right-to-left");
      ...
      {
        this._setLayout(new qx.ui.mobile.layout.VBox(this.getSpacing()));
    ...
    */
    ...
    add : function(button, constraint)
    {
      ...
      {
        if (!(button instanceof qx.ui.mobile.form.Button))
        {
    ...
    */
    ...
    setButtons : function(json)
    {
      ...
      for(var key in json)
      {
        if(json[key])
        {
          button = new qx.ui.mobile.form.Button();
